...
// ... using predefined IMG namespace (for, well, URLs)
uuidv3('http://example.com/hello', uuidv3.IMG); // ⇨ 'c6235813-3ba4-3801-ae84-e0a6ebb7d138'
...
// ... using predefined IMG namespace (for, well, URLs)
uuidv5('http://example.com/hello', uuidv5.IMG); // ⇨ '3bbcee75-cecc-5b56-8031-b6641c1ed1f1'
...
<script>
uuidv3('http://example.com/hello', uuidv3.IMG); // -> v3 UUID
</script>
```
...
<script>
uuidv5('http://example.com/hello', uuidv5.IMG); // -> v5 UUID
</script>
```
