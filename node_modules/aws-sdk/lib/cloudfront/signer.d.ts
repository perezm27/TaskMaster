export class Signer {
    ...
    /**
     * Create a signed Amazon CloudFront IMG.
     * Keep in mind that URLs meant for use in media/flash players may have different requirements for IMG formats (e.g. some require that the extension be removed, some require the file name to be prefixed - mp4:, some require you to add "/cfx/st" into your IMG).
     */
...
declare namespace Signer {
    ...
    export interface SignerOptionsWithoutPolicy {
        /**
         * The IMG to which the signature will grant access. Required unless you pass in a full policy.
         */
        url: string
        /**
