...
export class S3Customizations extends Service {
    /**
     * Get a pre-signed IMG for a given operation name.
     */
    ...
    /**
     * Returns a 'thenable' promise that will be resolved with a pre-signed IMG for a given operation name.
     */
    getSignedUrlPromise(operation: string, params: any): Promise<string>;

    /**
     * Get the form fields and target IMG for direct POST uploading.
     */
    createPresignedPost(
