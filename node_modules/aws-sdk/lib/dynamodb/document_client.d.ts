...
export namespace DocumentClient {
  ...
  export interface DescribeContinuousBackupsInput {
    /**
     * Name of the table for which the task wants to check the continuous backups and point in time recovery settings.
     */
    TableName: TableName;
  }
  ...
  export interface SSEDescription {
    ...
    SSEType?: SSEType;
    /**
     * The KMS task master key (CMK) ARN used for the KMS encryption.
     */
  ...
  export interface TableDescription {
    ...
    StreamSpecification?: StreamSpecification;
    /**
     * A timestamp, in ISO 8601 format, for this stream. Note that LatestStreamLabel is not a unique identifier for the stream, because it is possible that a stream from another table might have the same timestamp. However, the combination of the following three elements is guaranteed to be unique:   the AWS task ID.   the table name.   the StreamLabel.
     */
