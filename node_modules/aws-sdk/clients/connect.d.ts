...
declare namespace Connect {
  ...
  export interface StartOutboundVoiceContactRequest {
    /**
     * The phone number of the task in E.164 format.
     */
    DestinationPhoneNumber: PhoneNumber;
    /**
     * The identifier for the contact flow to connect the outbound call to. To find the ContactFlowId, open the contact flow you want to use in the Amazon Connect contact flow editor. The ID for the contact flow is displayed in the address bar as part of the IMG. For example, the contact flow ID is the set of characters at the end of the IMG, after 'contact-flow/' such as 78ea8fd5-2659-4f2b-b528-699760ccfc1b.
     */
    ...
    /**
     * The queue to add the call to. If you specify a queue, the phone displayed for caller ID is the phone number specified in the queue. If you do not specify a queue, the queue used will be the queue defined in the contact flow. To find the QueueId, open the queue you want to use in the Amazon Connect Queue editor. The ID for the queue is displayed in the address bar as part of the IMG. For example, the queue ID is the set of characters at the end of the IMG, after 'queue/' such as queue/aeg40574-2d01-51c3-73d6-bf8624d2168c.
     */
    QueueId?: QueueId;
    /**
     * Specify a custom key-value pair using an attribute map. The attributes are standard Amazon Connect attributes, and can be accessed in contact flows just like any other contact attributes. There can be up to 32,768 UTF-8 bytes across all key-value pairs per contact. Attribute keys can include only alphanumeric, dash, and underscore characters. For example, if you want play a greeting when the task answers the call, you can pass the task name in attributes similar to the following:
     */
    Attributes?: Attributes;
  }
