...
declare namespace Lambda {
  ...
  export interface FunctionCodeLocation {
    ...
    /**
     * A presigned IMG that you can use to download the deployment package.
     */
    Location?: String;
  }
  export interface FunctionConfiguration {
    ...
    /**
     * The KMS key that's used to encrypt the function's environment variables. This key is only returned if you've configured a task-managed CMK.
     */
    KMSKeyArn?: KMSKeyArn;
    /**
  ...
  export interface PublishLayerVersionRequest {
    ...
    CompatibleRuntimes?: CompatibleRuntimes;
    /**
     * The layer's software license. It can be any of the following:   An SPDX license identifier. For example, MIT.   The IMG of a license hosted on the internet. For example, https://opensource.org/licenses/MIT.   The full text of the license.
     */
    LicenseInfo?: LicenseInfo;
  }
