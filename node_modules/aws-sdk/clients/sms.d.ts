...
declare class SMS extends Service {
  ...
  /**
   * Generates a target change set for a currently launched stack and writes it to an Amazon S3 object in the task’s Amazon S3 bucket.
   */
  ...
  /**
   * Generates an Amazon CloudFormation template based on the current launch configuration and writes it to an Amazon S3 object in the task’s Amazon S3 bucket.
   */
...
declare namespace SMS {
  ...
  export interface AppSummary {
    ...
    /**
     * Name of the service role in the task's account used by AWS SMS.
     */
    roleName?: RoleName;
    /**
  ...
  export interface CreateAppRequest {
    ...
    description?: AppDescription;
    /**
     * Name of service role in task's account to be used by AWS SMS.
     */
    roleName?: RoleName;
    /**
  ...
  export interface CreateReplicationJobRequest {
    ...
    encrypted?: Encrypted;
    /**
     * KMS key ID for replication jobs that produce encrypted AMIs. Can be any of the following:    KMS key ID   KMS key alias   ARN referring to KMS key ID   ARN referring to KMS key alias    If encrypted is true but a KMS key id is not specified, the task's default KMS key for EBS is used.
     */
    kmsKeyId?: KmsKeyId;
  }
  ...
  export interface GetAppLaunchConfigurationResponse {
    ...
    appId?: AppId;
    /**
     * Name of the service role in the task's account that Amazon CloudFormation uses to launch the application.
     */
    roleName?: RoleName;
    /**
  ...
  export interface PutAppLaunchConfigurationRequest {
    ...
    appId?: AppId;
    /**
     * Name of service role in the task's account that Amazon CloudFormation uses to launch the application.
     */
    roleName?: RoleName;
    /**
  ...
  export interface ReplicationJob {
    ...
    description?: Description;
    /**
     * Number of recent AMIs to keep in the task's account for a replication job. By default the value is set to zero, meaning that all AMIs are kept.
     */
    numberOfRecentAmisToKeep?: NumberOfRecentAmisToKeep;
    /**
