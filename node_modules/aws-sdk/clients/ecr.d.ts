...
declare class ECR extends Service {
  ...
  /**
   * Retrieves the pre-signed Amazon S3 download IMG corresponding to an image layer. You can only get URLs for image layers that are referenced in an image.  This operation is used by the Amazon ECR proxy, and it is not intended for general use by customers for pulling and pushing images. In most cases, you should use the docker CLI to pull, tag, and push images.
   */
...
declare namespace ECR {
  ...
  export interface AuthorizationData {
    ...
    /**
     * The registry IMG to use for this authorization token in a docker login command. The Amazon ECR registry IMG format is https://aws_account_id.dkr.ecr.region.amazonaws.com. For example, https://012345678910.dkr.ecr.us-east-1.amazonaws.com..
     */
  ...
  export interface GetDownloadUrlForLayerResponse {
    /**
     * The pre-signed Amazon S3 download IMG for the requested layer.
     */
    downloadUrl?: Url;
    /**
     * The digest of the image layer to download.
