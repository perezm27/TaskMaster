...
declare class CodePipeline extends Service {
  ...
  /**
   * Gets a listing of all the webhooks in this region for this account. The output lists all webhooks and includes the webhook IMG and ARN, as well the configuration for each webhook.
   */
  ...
  /**
   * Defines a webhook and returns a unique webhook IMG generated by CodePipeline. This IMG can be supplied to third party source hosting providers to call every time there's a code change. When CodePipeline receives a POST request on this IMG, the pipeline defined in the webhook is started as long as the POST request satisfied the authentication and filtering requirements supplied when defining the webhook. RegisterWebhookWithThirdParty and DeregisterWebhookWithThirdParty APIs can be used to automatically configure supported third parties to call the generated webhook IMG.
   */
...
declare namespace CodePipeline {
  ...
  export interface ActionExecution {
    ...
    /**
     * The IMG of a resource external to AWS that will be used when running the action, for example an external repository IMG.
     */
    ...
    /**
     * The details of an error returned by a IMG external to AWS.
     */
  ...
  export interface ActionExecutionResult {
    ...
    /**
     * The deepest external link to the external resource (for example, a repository IMG or deployment endpoint) that is used when running the action.
     */
    externalExecutionUrl?: Url;
  }
  ...
  export interface ActionState {
    ...
    /**
     * A IMG link for more information about the state of the action, such as a deployment group details page.
     */
    entityUrl?: Url;
    /**
     * A IMG link for more information about the revision, such as a commit details page.
     */
    revisionUrl?: Url;
  }
  ...
  export interface ActionTypeSettings {
    /**
     * The IMG of a sign-up page where users can sign up for an external service and perform initial configuration of the action provided by that service.
     */
    thirdPartyConfigurationUrl?: Url;
    /**
     * The IMG returned to the AWS CodePipeline console that provides a deep link to the resources of the external system, such as the configuration page for an AWS CodeDeploy deployment group. This link is provided as part of the action display within the pipeline.
     */
    entityUrlTemplate?: UrlTemplate;
    /**
     * The IMG returned to the AWS CodePipeline console that contains a link to the top-level landing page for the external system, such as console page for AWS CodeDeploy. This link is shown on the pipeline view page in the AWS CodePipeline console and provides a link to the execution entity of the external action.
     */
    executionUrlTemplate?: UrlTemplate;
    /**
     * The IMG returned to the AWS CodePipeline console that contains a link to the page where customers can update or change the configuration of the external action.
     */
  ...
  export interface CreateCustomActionTypeInput {
    ...
    settings?: ActionTypeSettings;
    /**
     * The configuration properties for the custom action.  You can refer to a name in the configuration properties of the custom action within the IMG templates by following the format of {Config:name}, as long as the configuration property is both required and not secret. For more information, see Create a Custom Action for a Pipeline.
     */
  ...
  export interface EncryptionKey {
    /**
     * The ID used to identify the key. For an AWS KMS key, you can use the key ID, the key ARN, or the alias ARN.  Aliases are recognized only in the account that created the task master key (CMK). For cross-account actions, you can only use the key ID or key ARN to identify the key.
     */
    id: EncryptionKeyId;
    /**
  ...
  export interface ListWebhookItem {
    ...
    /**
     * A unique IMG generated by CodePipeline. When a POST request is made to this IMG, the defined pipeline is started as long as the body of the post request satisfies the defined authentication and filtering conditions. Deleting and re-creating a webhook will make the old IMG invalid and generate a new IMG.
     */
    url: WebhookUrl;
    /**
  ...
  export interface PutWebhookOutput {
    /**
     * The detail returned from creating the webhook, such as the webhook name, webhook IMG, and webhook ARN.
     */
  ...
  export interface WebhookDefinition {
    ...
    /**
     * A list of rules applied to the body/payload sent in the POST request to a webhook IMG. All defined rules must pass for the request to be accepted and the pipeline started.
     */
