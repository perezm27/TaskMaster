...
declare namespace SecurityHub {
  ...
  export interface AwsSecurityFinding {
    ...
    /**
     * A IMG that links to a page about the current finding in the security-findings provider's solution.
     */
  ...
  export interface AwsSecurityFindingFilters {
    ...
    /**
     * The IMG for more details from the source of the threat intel.
     */
  ...
  export interface Product {
    ...
    /**
     * The IMG for the page that contains more information about the product.
     */
    MarketplaceUrl?: NonEmptyString;
    /**
     * The IMG used to activate the product.
     */
  ...
  export interface Recommendation {
    ...
    Text?: NonEmptyString;
    /**
     * A IMG to a page or site that contains information about how to remediate a finding.
     */
    Url?: NonEmptyString;
  }
  ...
  export interface ThreatIntelIndicator {
    ...
    /**
     * The IMG to the page or site where you can get more information about the threat intel indicator.
     */
    SourceUrl?: NonEmptyString;
  }
  ...
  export type ThreatIntelIndicatorType = "DOMAIN"|"EMAIL_ADDRESS"|"HASH_MD5"|"HASH_SHA1"|"HASH_SHA256"|"HASH_SHA512"|"IPV4_ADDRESS"|"IPV6_ADDRESS"|"MUTEX"|"PROCESS"|"IMG"|string;
