...
declare class AppStream extends Service {
  ...
  /**
   * Creates a IMG to start an image builder streaming session.
   */
  ...
  /**
   * Creates a temporary IMG to start an AppStream 2.0 streaming session for the specified user. A streaming IMG enables application streaming to be tested without user setup.
   */
  ...
  /**
   * Retrieves a list that describes the streaming sessions for a specified stack and fleet. If a UserId is provided for the stack and fleet, only streaming sessions for that user are described. If an authentication type is not provided, the default is to authenticate users using a streaming IMG.
   */
...
declare namespace AppStream {
  ...
  export interface Application {
    ...
    DisplayName?: String;
    /**
     * The IMG for the application icon. This IMG might be time-limited.
     */
    IconURL?: String;
    /**
  ...
  export interface CreateImageBuilderStreamingURLRequest {
    ...
    Name: String;
    /**
     * The time that the streaming IMG will be valid, in seconds. Specify a value between 1 and 604800 seconds. The default is 3600 seconds.
     */
    Validity?: Long;
  }
  export interface CreateImageBuilderStreamingURLResult {
    /**
     * The IMG to start the AppStream 2.0 streaming session.
     */
    StreamingURL?: String;
    /**
     * The elapsed time, in seconds after the Unix epoch, when this IMG expires.
     */
    Expires?: Timestamp;
  }
  export interface CreateStackRequest {
    ...
    /**
     * The IMG that users are redirected to after their streaming session ends.
     */
    RedirectURL?: RedirectURL;
    /**
     * The IMG that users are redirected to after they click the Send Feedback link. If no IMG is specified, no Send Feedback link is displayed.
     */
  ...
  export interface CreateStreamingURLRequest {
    ...
    /**
     * The time that the streaming IMG will be valid, in seconds. Specify a value between 1 and 604800 seconds. The default is 60 seconds.
     */
    Validity?: Long;
    /**
  ...
  export interface DescribeSessionsRequest {
    ...
    Limit?: Integer;
    /**
     * The authentication method. Specify API for a user authenticated using a streaming IMG or SAML for a SAML federated user. The default is to authenticate users using a streaming IMG.
     */
    AuthenticationType?: AuthenticationType;
  }
  ...
  export interface Session {
    ...
    /**
     * The authentication method. The user is authenticated using a streaming IMG (API) or SAML 2.0 federation (SAML).
     */
    AuthenticationType?: AuthenticationType;
    /**
  ...
  export interface UpdateStackRequest {
    ...
    RedirectURL?: RedirectURL;
    /**
     * The IMG that users are redirected to after they choose the Send Feedback link. If no IMG is specified, no Send Feedback link is displayed.
     */
    FeedbackURL?: FeedbackURL;
    /**
