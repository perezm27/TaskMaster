...
declare class Redshift extends Service {
  ...
  /**
   * Authorizes the specified AWS task account to restore the specified snapshot.  For more information about working with snapshots, go to Amazon Redshift Snapshots in the Amazon Redshift Cluster Management Guide.
   */
  ...
  /**
   * Returns one or more snapshot objects, which contain metadata about your cluster snapshots. By default, this operation returns information about all snapshots of all clusters that are owned by you AWS task account. No information is returned for snapshots owned by inactive AWS task accounts. If you specify both tag keys and tag values in the same request, Amazon Redshift returns all snapshots that match any combination of the specified keys and values. For example, if you have owner and environment for tag keys, and admin and test for tag values, all snapshots that have any combination of those values are returned. Only snapshots that you own are returned in the response; shared snapshots are not returned with the tag key and tag value request parameters. If both tag keys and values are omitted from the request, snapshots are returned regardless of whether they have tag keys or values associated with them.
   */
  ...
  /**
   * Disables the automatic copying of snapshots from one region to another region for a specified cluster. If your cluster and its snapshots are encrypted using a task master key (CMK) from AWS KMS, use DeleteSnapshotCopyGrant to delete the grant that grants Amazon Redshift permission to the CMK in the destination region.
   */
  ...
  /**
   * Removes the ability of the specified AWS task account to restore the specified snapshot. If the account is currently restoring the snapshot, the restore will run to completion.  For more information about working with snapshots, go to Amazon Redshift Snapshots in the Amazon Redshift Cluster Management Guide.
   */
...
declare namespace Redshift {
  ...
  export interface AccountWithRestoreAccess {
    /**
     * The identifier of an AWS task account authorized to restore a snapshot.
     */
    AccountId?: String;
    /**
  ...
  export interface AuthorizeSnapshotAccessMessage {
    ...
    /**
     * The identifier of the AWS task account authorized to restore the specified snapshot. To share a snapshot with AWS support, specify amazon-redshift-support.
     */
  ...
  export interface CreateSnapshotCopyGrantMessage {
    ...
    SnapshotCopyGrantName: String;
    /**
     * The unique identifier of the task master key (CMK) to which to grant Amazon Redshift permission. If no key is specified, the default key is used.
     */
    KmsKeyId?: String;
    /**
     * A list of tag instances.
  ...
  export interface DescribeClusterSnapshotsMessage {
    ...
    Marker?: String;
    /**
     * The AWS task account used to create or copy the snapshot. Use this field to filter the results to snapshots owned by a particular account. To describe snapshots you own, either specify your AWS task account, or do not specify the parameter.
     */
    OwnerAccount?: String;
    /**
  ...
  export interface DescribeHsmClientCertificatesMessage {
    /**
     * The identifier of a specific HSM client certificate for which you want information. If no identifier is specified, information is returned for all HSM client certificates owned by your AWS task account.
     */
    HsmClientCertificateIdentifier?: String;
    /**
     * The maximum number of response records to return in each call. If the number of remaining response records exceeds the specified MaxRecords value, a value is returned in a marker field of the response. You can retrieve the next set of records by retrying the command with the returned marker value.  Default: 100  Constraints: minimum 20, maximum 100.
  ...
  export interface DescribeHsmConfigurationsMessage {
    /**
     * The identifier of a specific Amazon Redshift HSM configuration to be described. If no identifier is specified, information is returned for all HSM configurations owned by your AWS task account.
     */
    HsmConfigurationIdentifier?: String;
    /**
     * The maximum number of response records to return in each call. If the number of remaining response records exceeds the specified MaxRecords value, a value is returned in a marker field of the response. You can retrieve the next set of records by retrying the command with the returned marker value.  Default: 100  Constraints: minimum 20, maximum 100.
  ...
  export interface EventSubscription {
    /**
     * The AWS task account associated with the Amazon Redshift event notification subscription.
     */
  ...
  export interface RestoreFromClusterSnapshotMessage {
    ...
    PubliclyAccessible?: BooleanOptional;
    /**
     * The AWS task account used to create or copy the snapshot. Required if you are restoring a snapshot you do not own, optional if you own the snapshot.
     */
    OwnerAccount?: String;
    /**
     * Specifies the name of the HSM client certificate the Amazon Redshift cluster uses to retrieve the data encryption keys stored in an HSM.
  ...
  export interface RevokeSnapshotAccessMessage {
    ...
    SnapshotClusterIdentifier?: String;
    /**
     * The identifier of the AWS task account that can no longer restore the specified snapshot.
     */
    AccountWithRestoreAccess: String;
  }
  ...
  export interface Snapshot {
    ...
    /**
     * A list of the AWS task accounts authorized to restore the snapshot. Returns null if no accounts are authorized. Visible only to the snapshot owner.
     */
    AccountsWithRestoreAccess?: AccountsWithRestoreAccessList;
    /**
     * For manual snapshots, the AWS task account used to create or copy the snapshot. For automatic snapshots, the owner of the cluster. The owner can perform all snapshot actions, such as sharing a manual snapshot.
     */
    OwnerAccount?: String;
    /**
  ...
  export interface SnapshotCopyGrant {
    ...
    SnapshotCopyGrantName?: String;
    /**
     * The unique identifier of the task master key (CMK) in AWS KMS to which Amazon Redshift is granted permission.
     */
    KmsKeyId?: String;
    /**
     * A list of tag instances.
