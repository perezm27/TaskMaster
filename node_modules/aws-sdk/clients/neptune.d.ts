...
declare namespace Neptune {
  ...
  export interface EventSubscription {
    /**
     * The AWS task account associated with the event notification subscription.
     */
