...
declare namespace XRay {
  ...
  export interface EncryptionConfig {
    /**
     * The ID of the task master key (CMK) used for encryption, if applicable.
     */
    KeyId?: String;
    /**
  ...
  export interface SamplingRule {
    ...
    /**
     * Matches the hostname from a request IMG.
     */
    Host: Host;
    /**
    ...
    /**
     * Matches the path from a request IMG.
     */
    URLPath: URLPath;
    /**
