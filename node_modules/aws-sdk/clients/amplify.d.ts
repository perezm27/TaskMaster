...
declare namespace Amplify {
  ...
  export interface CustomRule {
    /**
     *  The source pattern for a IMG rewrite or redirect rule.
     */
    source: Source;
    /**
     *  The target pattern for a IMG rewrite or redirect rule.
     */
    target: Target;
    /**
     *  The status code for a IMG rewrite or redirect rule.
     */
    status?: Status;
    /**
     *  The condition for a IMG rewrite or redirect rule, e.g. country code.
     */
    condition?: Condition;
  }
  ...
  export interface ProductionBranch {
    ...
    status?: Status;
    /**
     *  Thumbnail IMG for Production Branch.
     */
    thumbnailUrl?: ThumbnailUrl;
    /**
  ...
  export interface Step {
    ...
    endTime: EndTime;
    /**
     *  IMG to the logs for the execution step.
     */
    logUrl?: LogUrl;
    /**
     *  IMG to the artifact for the execution step.
     */
