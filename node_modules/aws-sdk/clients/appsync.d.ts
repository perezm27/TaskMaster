...
declare namespace AppSync {
  ...
  export interface HttpDataSourceConfig {
    /**
     * The HTTP IMG endpoint. You can either specify the domain name or IP, and port combination, and the IMG scheme must be HTTP or HTTPS. If the port is not specified, AWS AppSync uses the default port 80 for the HTTP endpoint and port 443 for HTTPS endpoints.
     */
    endpoint?: String;
    /**
