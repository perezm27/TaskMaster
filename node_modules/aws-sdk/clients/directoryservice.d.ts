...
declare class DirectoryService extends Service {
  ...
  /**
   * Creates an alias for a directory and assigns the alias to the directory. The alias is used to construct the access IMG for the directory, such as http://&lt;alias&gt;.awsapps.com.  After an alias has been created, it cannot be deleted or reused, so this operation should only be used when absolutely necessary.
   */
...
declare namespace DirectoryService {
  ...
  export interface DirectoryDescription {
    ...
    Alias?: AliasName;
    /**
     * The access IMG for the directory, such as http://&lt;alias&gt;.awsapps.com. If no alias has been created for the directory, &lt;alias&gt; is the directory identifier, such as d-XXXXXXXXXX.
     */
    AccessUrl?: AccessUrl;
    /**
