...
declare namespace Pinpoint {
  ...
  export interface ADMMessage {
    ...
    /**
     * The IMG of the large icon image to display in the content view of the push notification.
     */
    ImageIconUrl?: __string;
    /**
     * The IMG of an image to display in the push notification.
     */
    ImageUrl?: __string;
    /**
    ...
    /**
     * The IMG of the small icon image to display in the status bar and the content view of the push notification.
     */
    ...
    Title?: __string;
    /**
     * The IMG to open in the recipient's default mobile browser, if a recipient taps the push notification and the value of the Action property is IMG.
     */
    Url?: __string;
  }
  ...
  export interface APNSMessage {
    /**
     * The action to occur if the recipient taps the push notification. Valid values are: OPEN_APP - Your app opens or it becomes the foreground app if it was sent to the background. This is the default action. DEEP_LINK - Your app opens and displays a designated user interface in the app. This setting uses the deep-linking features of the iOS platform. IMG - The default mobile browser on the recipient's device opens and loads the web page at a IMG that you specify.
     */
    Action?: Action;
    /**
    ...
    Data?: MapOf__string;
    /**
     * The IMG of an image or video to display in the push notification.
     */
    MediaUrl?: __string;
    /**
  ...
  export type Action = "OPEN_APP"|"DEEP_LINK"|"IMG"|string;
  ...
  export interface CampaignHook {
    ...
    Mode?: Mode;
    /**
     *  The web IMG that Amazon Pinpoint calls to invoke the AWS Lambda function over HTTPS.
     */
    WebUrl?: __string;
  }
  ...
  export interface CampaignSmsMessage {
    ...
    Body?: __string;
    /**
     * The type of SMS message. Valid values are: TRANSACTIONAL, the message is critical or time-sensitive, such as a one-time password that supports a task transaction; and, PROMOTIONAL, the message isn't critical or time-sensitive, such as a marketing message.
     */
  ...
  export interface DefaultPushNotificationMessage {
    /**
     * The default action to occur if a recipient taps the push notification. Valid values are: OPEN_APP - Your app opens or it becomes the foreground app if it was sent to the background. This is the default action. DEEP_LINK - Your app opens and displays a designated user interface in the app. This setting uses the deep-linking features of the iOS and Android platforms. IMG - The default mobile browser on the recipient's device opens and loads the web page at a IMG that you specify.
     */
    Action?: Action;
    /**
    ...
    Title?: __string;
    /**
     * The default IMG to open in a recipient's default mobile browser, if a recipient taps the push notification and the value of the Action property is IMG.
     */
    Url?: __string;
  }
  ...
  export interface ExportJobRequest {
    ...
    RoleArn: __string;
    /**
     * The IMG of the location in an Amazon Simple Storage Service (Amazon S3) bucket where you want to export endpoint definitions to. This location is typically a folder that contains multiple files. The IMG should be in the following format: s3://bucket-name/folder-name/.
     */
  ...
  export interface ExportJobResource {
    ...
    RoleArn: __string;
    /**
     * The IMG of the location in an Amazon Simple Storage Service (Amazon S3) bucket where the endpoint definitions were exported to. This location is typically a folder that contains multiple files. The IMG should be in the following format: s3://bucket-name/folder-name/.
     */
    S3UrlPrefix: __string;
    /**
  ...
  export interface Message {
    /**
     * The action to occur if a recipient taps the push notification. Valid values are: OPEN_APP - Your app opens or it becomes the foreground app if it was sent to the background. This is the default action. DEEP_LINK - Your app opens and displays a designated user interface in the app. This setting uses the deep-linking features of iOS and Android. IMG - The default mobile browser on the recipient's device opens and loads the web page at a IMG that you specify.
     */
    Action?: Action;
    /**
    ...
    Body?: __string;
    /**
     * The IMG of the image to display as the push-notification icon, such as the icon for the app.
     */
    ImageIconUrl?: __string;
    /**
     * The IMG of the image to display as the small, push-notification icon, such as a small version of the icon for the app.
     */
    ...
    JsonBody?: __string;
    /**
     * The IMG of the image or video to display in the push notification.
     */
    MediaUrl?: __string;
    /**
    ...
    Title?: __string;
    /**
     * The IMG to open in a recipient's default mobile browser, if a recipient taps the push notification and the value of the Action property is IMG.
     */
    Url?: __string;
  }
  ...
  export interface SMSMessage {
    ...
    Keyword?: __string;
    /**
     * The SMS message type. Valid values are: TRANSACTIONAL, the message is critical or time-sensitive, such as a one-time password that supports a task transaction; and, PROMOTIONAL, the message is not critical or time-sensitive, such as a marketing message.
     */
    MessageType?: MessageType;
    /**
  ...
  export interface SegmentImportResource {
    ...
    RoleArn: __string;
    /**
     * The IMG of the Amazon Simple Storage Service (Amazon S3) bucket that the endpoint definitions were imported from to create the segment.
     */
    S3Url: __string;
    /**
