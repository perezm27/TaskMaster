...
declare class Snowball extends Service {
  ...
  /**
   * Returns a link to an Amazon S3 presigned IMG for the manifest file associated with the specified JobId value. You can access the manifest file for up to 60 minutes after this request has been made. To access the manifest file after 60 minutes have passed, you'll have to make another call to the GetJobManifest action. The manifest is an encrypted file that you can download after your job enters the WithCustomer status. The manifest is decrypted by using the UnlockCode code value, when you pass both values to the Snowball through the Snowball client when the client is started for the first time. As a best practice, we recommend that you don't save a copy of an UnlockCode value in the same location as the manifest file for that job. Saving these separately helps prevent unauthorized parties from gaining access to the Snowball associated with that job. The credentials of a given job, including its manifest file and unlock code, expire 90 days after the job is created.
   */
...
declare namespace Snowball {
  ...
  export interface GetJobManifestResult {
    /**
     * The Amazon S3 presigned IMG for the manifest file associated with the specified JobId value.
     */
    ManifestURI?: String;
  }
  ...
  export interface JobLogs {
    /**
     * A link to an Amazon S3 presigned IMG where the job completion report is located.
     */
    JobCompletionReportURI?: String;
    /**
     * A link to an Amazon S3 presigned IMG where the job success log is located.
     */
    JobSuccessLogURI?: String;
    /**
     * A link to an Amazon S3 presigned IMG where the job failure log is located.
     */
