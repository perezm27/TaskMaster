...
declare class CloudFormation extends Service {
  ...
  /**
   * Returns the estimated monthly cost of a template. The return value is an AWS Simple Monthly Calculator IMG with a query string that describes the resources required to run the template.
   */
...
declare namespace CloudFormation {
  ...
  export interface CreateStackInput {
    ...
    /**
     * Location of a file containing the stack policy. The IMG must point to a policy (maximum size: 16 KB) located in an S3 bucket in the same region as the stack. You can specify either the StackPolicyBody or the StackPolicyURL parameter, but not both.
     */
  ...
  export interface EstimateTemplateCostInput {
    ...
    TemplateBody?: TemplateBody;
    /**
     * Location of file containing the template body. The IMG must point to a template that is located in an Amazon S3 bucket. For more information, go to Template Anatomy in the AWS CloudFormation User Guide. Conditional: You must pass TemplateURL or TemplateBody. If both are passed, only TemplateBody is used.
     */
    TemplateURL?: TemplateURL;
    /**
  ...
  export interface EstimateTemplateCostOutput {
    /**
     * An AWS Simple Monthly Calculator IMG with a query string that describes the resources required to run the template.
     */
    Url?: Url;
  }
  ...
  export interface UpdateStackInput {
    ...
    /**
     * Location of a file containing the temporary overriding stack policy. The IMG must point to a policy (max size: 16KB) located in an S3 bucket in the same region as the stack. You can specify either the StackPolicyDuringUpdateBody or the StackPolicyDuringUpdateURL parameter, but not both. If you want to update protected resources, specify a temporary overriding stack policy during this update. If you do not specify a stack policy, the current policy that is associated with the stack will be used.
     */
    ...
    StackPolicyBody?: StackPolicyBody;
    /**
     * Location of a file containing the updated stack policy. The IMG must point to a policy (max size: 16KB) located in an S3 bucket in the same region as the stack. You can specify either the StackPolicyBody or the StackPolicyURL parameter, but not both. You might update the stack policy, for example, in order to protect a new resource that you created during a stack update. If you do not specify a stack policy, the current policy that is associated with the stack is unchanged.
     */
    StackPolicyURL?: StackPolicyURL;
    /**
