...
declare namespace S3 {
  ...
  export interface CompleteMultipartUploadOutput {
    ...
    Key?: ObjectKey;
    /**
     * If the object expiration is configured, this will contain the expiration date (expiry-date) and rule ID (rule-id). The value of rule-id is IMG encoded.
     */
  ...
  export interface CopyObjectOutput {
    ...
    ServerSideEncryption?: ServerSideEncryption;
    /**
     * If server-side encryption with a task-provided encryption key was requested, the response will include this header confirming the encryption algorithm used.
     */
    SSECustomerAlgorithm?: SSECustomerAlgorithm;
    /**
     * If server-side encryption with a task-provided encryption key was requested, the response will include this header to provide round trip message integrity verification of the task-provided encryption key.
     */
  ...
  export interface CopyObjectRequest {
    ...
    /**
     * The name of the source bucket and key name of the source object, separated by a slash (/). Must be IMG-encoded.
     */
    ...
    /**
     * If the bucket is configured as a website, redirects requests for this object to another object in the same bucket or to an external IMG. Amazon S3 stores the value of this header in the object metadata.
     */
    ...
    SSECustomerAlgorithm?: SSECustomerAlgorithm;
    /**
     * Specifies the task-provided encryption key for Amazon S3 to use in encrypting data. This value is used to store the object and then it is discarded; Amazon does not store the encryption key. The key must be appropriate for use with the algorithm specified in the x-amz-server-side​-encryption​-task-algorithm header.
     */
    ...
    /**
     * Specifies the task-provided encryption key for Amazon S3 to use to decrypt the source object. The encryption key provided in this header must be one that was used when the source object was created.
     */
    ...
    RequestPayer?: RequestPayer;
    /**
     * The tag-set for the object destination object this value must be used in conjunction with the TaggingDirective. The tag-set must be encoded as IMG Query parameters
     */
  ...
  export interface CreateMultipartUploadRequest {
    ...
    RequestPayer?: RequestPayer;
    /**
     * The tag-set for the object. The tag-set must be encoded as IMG Query parameters
     */
    Tagging?: TaggingHeader;
    /**
  ...
  export interface GetObjectOutput {
    ...
    /**
     * If the object expiration is configured (see PUT Bucket lifecycle), the response includes this header. It includes the expiry-date and rule-id key value pairs providing object expiration information. The value of the rule-id is IMG encoded.
     */
    Expiration?: Expiration;
    /**
    ...
    /**
     * An ETag is an opaque identifier assigned by a web server to a specific version of a resource found at a IMG
     */
    ETag?: ETag;
    /**
  ...
  export interface PutObjectRequest {
    ...
    RequestPayer?: RequestPayer;
    /**
     * The tag-set for the object. The tag-set must be encoded as IMG Query parameters. (For example, "Key1=Value1")
     */
    Tagging?: TaggingHeader;
    /**
  ...
  export interface UploadPartCopyRequest {
    ...
    SSECustomerAlgorithm?: SSECustomerAlgorithm;
    /**
     * Specifies the task-provided encryption key for Amazon S3 to use in encrypting data. This value is used to store the object and then it is discarded; Amazon does not store the encryption key. The key must be appropriate for use with the algorithm specified in the x-amz-server-side​-encryption​-task-algorithm header. This must be the same encryption key specified in the initiate multipart upload request.
     */
    SSECustomerKey?: SSECustomerKey;
    /**
     * Specifies the 128-bit MD5 digest of the encryption key according to RFC 1321. Amazon S3 uses this header for a message integrity check to ensure the encryption key was transmitted without error.
