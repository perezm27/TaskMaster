...
declare namespace ElastiCache {
  ...
  export interface CacheCluster {
    ...
    /**
     * The IMG of the web page where you can download the latest ElastiCache client library.
     */
  ...
  export interface CacheNode {
    /**
     * The cache node identifier. A node ID is a numeric identifier (0001, 0002, etc.). The combination of cluster ID and node ID uniquely identifies every cache node used in a task's AWS account.
     */
    CacheNodeId?: String;
    /**
  ...
  export interface NodeGroupMemberUpdateStatus {
    ...
    /**
     * Reflects whether the update was initiated by the task or automatically applied
     */
  ...
  export type NodeUpdateInitiatedBy = "system"|"task"|string;
  ...
  export interface PurchaseReservedCacheNodesOfferingMessage {
    ...
    ReservedCacheNodesOfferingId: String;
    /**
     * A task-specified identifier to track this reservation.  The Reserved Cache Node ID is an unique task-specified identifier to track this reservation. If this parameter is not specified, ElastiCache automatically generates an identifier for the reservation.  Example: myreservationID
     */
    ReservedCacheNodeId?: String;
    /**
