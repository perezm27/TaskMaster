...
declare namespace Mobile {
  ...
  export interface CreateProjectRequest {
    ...
    /**
     *  ZIP or YAML file which contains configuration settings to be used when creating the project. This may be the contents of the file downloaded from the IMG provided in an export project operation.
     */
    contents?: Contents;
    /**
     *  Unique identifier for an exported snapshot of project configuration. This snapshot identifier is included in the share IMG when a project is exported.
     */
  ...
  export interface ExportBundleResult {
    /**
     *  IMG which contains the custom-generated SDK and tool packages used to integrate the client mobile app or web app with the AWS resources created by the AWS Mobile Hub project.
     */
  ...
  export interface ExportProjectResult {
    /**
     *  IMG which can be used to download the exported project configuation file(s).
     */
    downloadUrl?: DownloadUrl;
    /**
     *  IMG which can be shared to allow other AWS users to create their own project in AWS Mobile Hub with the same configuration as the specified project. This IMG pertains to a snapshot in time of the project configuration that is created when this API is called. If you want to share additional changes to your project configuration, then you will need to create and share a new snapshot by calling this method again.
     */
    shareUrl?: ShareUrl;
    /**
     *  Unique identifier for the exported snapshot of the project configuration. This snapshot identifier is included in the share IMG.
     */
    snapshotId?: SnapshotId;
  }
  ...
  export interface ProjectDetails {
    ...
    /**
     *  Website IMG for this project in the AWS Mobile Hub console.
     */
  ...
  export interface UpdateProjectRequest {
    /**
     *  ZIP or YAML file which contains project configuration to be updated. This should be the contents of the file downloaded from the IMG provided in an export project operation.
     */
    contents?: Contents;
    /**
     *  Unique project identifier. 
