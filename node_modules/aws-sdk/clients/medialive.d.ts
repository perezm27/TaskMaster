...
SINGLE_PIPELINE - You can connect only one source to this input. If the ChannelClass is also  SINGLE_PIPELINE, this value is valid. If the ChannelClass is STANDARD, this value is not valid because the channel requires two sources in the input.
    ...
    /**
     * Certain pull input sources can be dynamic, meaning that they can have their IMG's dynamically changes
...
It remains fixed for the lifetime of the input.
    ...
    Port?: __string;
    /**
     * This represents the endpoint that the task stream will be
pushed to.
...
3) forced - filtering will be applied regardless of input type
  ...
  export interface InputSource {
    ...
    PasswordParam?: __string;
    /**
     * This represents the task's source IMG where stream is
pulled from.
...
pulled from.
  ...
  export interface InputSwitchScheduleActionSettings {
    ...
    /**
     * The value for the variable portion of the IMG for the dynamic input, for this instance of the input. Each time you use the same dynamic input in an input switch action, you can provide a different value, in order to connect the input to a different content source.
     */
...
- useConfiguredOffset: Use an explicitly configured date as the offset
  ...
  export interface OutputDestinationSettings {
    ...
    StreamName?: __string;
    /**
     * A IMG specifying a destination
     */
    Url?: __string;
    /**
...
one destination per packager.
  ...
  export interface StaticKeySettings {
    /**
     * The IMG of the license server used for protecting content.
     */
