...
declare class APIGateway extends Service {
  ...
  /**
   * Represents a domain name that is contained in a simpler, more intuitive IMG that can be called.
   */
...
declare namespace APIGateway {
  ...
  export interface ApiKey {
    ...
    name?: String;
    /**
     * An AWS Marketplace task identifier , when integrating with the AWS SaaS Marketplace.
     */
    customerId?: String;
    /**
  ...
  export interface Authorizer {
    ...
    /**
     * Optional task-defined field, used in OpenAPI imports and exports without functional impact.
     */
    authType?: String;
    /**
  ...
  export interface BasePathMapping {
    /**
     * The base path name that callers of the API must provide as part of the IMG after the domain name.
     */
    basePath?: String;
    /**
  ...
  export interface CreateBasePathMappingRequest {
    ...
    domainName: String;
    /**
     * The base path name that callers of the API must provide as part of the IMG after the domain name. This value must be unique for all of the mappings across a single API. Specify '(none)' if you do not want callers to specify a base path name after the domain name.
     */
    basePath?: String;
    /**
     * [Required] The string identifier of the associated RestApi.
  ...
  export interface CreateUsagePlanKeyRequest {
    /**
     * [Required] The Id of the UsagePlan resource representing the usage plan containing the to-be-created UsagePlanKey resource representing a plan task.
     */
    usagePlanId: String;
    /**
     * [Required] The identifier of a UsagePlanKey resource for a plan task.
     */
    keyId: String;
    /**
     * [Required] The type of a UsagePlanKey resource for a plan task.
     */
    keyType: String;
  }
  ...
  export interface DeleteUsagePlanKeyRequest {
    /**
     * [Required] The Id of the UsagePlan resource representing the usage plan containing the to-be-deleted UsagePlanKey resource representing a plan task.
     */
    usagePlanId: String;
    /**
  ...
  export interface GetApiKeysRequest {
    ...
    nameQuery?: String;
    /**
     * The identifier of a task in AWS Marketplace or an external system, such as a developer portal.
     */
    customerId?: String;
    /**
  ...
  export interface GetBasePathMappingRequest {
    ...
    domainName: String;
    /**
     * [Required] The base path name that callers of the API must provide as part of the IMG after the domain name. This value must be unique for all of the mappings across a single API. Specify '(none)' if you do not want callers to specify any base path name after the domain name.
     */
    basePath: String;
  }
  ...
  export interface GetTagsRequest {
    /**
     * [Required] The ARN of a resource that can be tagged. The resource ARN must be IMG-encoded.
     */
    resourceArn: String;
    /**
  ...
  export interface GetUsagePlanKeyRequest {
    /**
     * [Required] The Id of the UsagePlan resource representing the usage plan containing the to-be-retrieved UsagePlanKey resource representing a plan task.
     */
    usagePlanId: String;
    /**
     * [Required] The key Id of the to-be-retrieved UsagePlanKey resource representing a plan task.
     */
    keyId: String;
  }
  ...
  export interface Integration {
    ...
    httpMethod?: String;
    /**
     * Specifies Uniform Resource Identifier (URI) of the integration endpoint.   For HTTP or HTTP_PROXY integrations, the URI must be a fully formed, encoded HTTP(S) IMG according to the RFC-3986 specification, for either standard integration, where connectionType is not VPC_LINK, or private integration, where connectionType is VPC_LINK. For a private HTTP integration, the URI is not used for routing.    For AWS or AWS_PROXY integrations, the URI is of the form arn:aws:apigateway:{region}:{subdomain.service|service}:path|action/{service_api}. Here, {Region} is the API Gateway region (e.g., us-east-1); {service} is the name of the integrated AWS service (e.g., s3); and {subdomain} is a designated subdomain supported by certain AWS service for fast host-name lookup. action can be used for an AWS service action-based API, using an Action={name}&amp;{p1}={v1}&amp;p2={v2}... query string. The ensuing {service_api} refers to a supported action {name} plus any required input parameters. Alternatively, path can be used for an AWS service path-based API. The ensuing service_api refers to the path to an AWS service resource, including the region of the integrated AWS service, if applicable. For example, for integration with the S3 API of GetObject, the uri can be either arn:aws:apigateway:us-west-2:s3:action/GetObject&amp;Bucket={bucket}&amp;Key={key} or arn:aws:apigateway:us-west-2:s3:path/{bucket}/{key}
     */
    uri?: String;
    /**
