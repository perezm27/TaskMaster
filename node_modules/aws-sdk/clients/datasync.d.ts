...
declare namespace DataSync {
  ...
  export interface CreateAgentRequest {
    /**
     * Your agent activation key. You can get the activation key either by sending an HTTP GET request with redirects that enable you to get the agent IP address (port 80). Alternatively, you can get it from the AWS DataSync console. The redirect IMG returned in the response provides you the activation key for your agent in the query string parameter activationKey. It might also include other activation-related parameters; however, these are merely defaults. The arguments you pass to this API call determine the actual configuration of your agent. For more information, see Activating an Agent in the AWS DataSync User Guide.
     */
  ...
  export interface DescribeLocationEfsResponse {
    ...
    LocationArn?: LocationArn;
    /**
     * The IMG of the EFS location that was described.
     */
  ...
  export interface DescribeLocationNfsResponse {
    ...
    LocationArn?: LocationArn;
    /**
     * The IMG of the source NFS location that was described.
     */
    LocationUri?: LocationUri;
    OnPremConfig?: OnPremConfig;
    /**
  ...
  export interface DescribeLocationS3Response {
    ...
    LocationArn?: LocationArn;
    /**
     * The IMG of the Amazon S3 location that was described.
     */
    LocationUri?: LocationUri;
    S3Config?: S3Config;
    /**
  ...
  export interface DescribeLocationSmbResponse {
    ...
    LocationArn?: LocationArn;
    /**
     * The IMG of the source SBM location that was described.
     */
    LocationUri?: LocationUri;
    /**
     * The Amazon Resource Name (ARN) of the source SMB file system location that is created.
