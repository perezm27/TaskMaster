...
declare class WorkLink extends Service {
  ...
  /**
   * Describes the configuration for delivering audit streams to the task account.
   */
...
declare namespace WorkLink {
  ...
  export interface UpdateIdentityProviderConfigurationRequest {
    ...
    IdentityProviderType: IdentityProviderType;
    /**
     * The SAML metadata document provided by the task’s identity provider. The existing IdentityProviderSamlMetadata is unset if null is passed.
     */
    IdentityProviderSamlMetadata?: SamlMetadata;
  }
