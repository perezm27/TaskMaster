...
declare namespace MQ {
  ...
  export interface BrokerInstance {
    /**
     * The IMG of the broker's ActiveMQ Web Console.
     */
    ConsoleURL?: __string;
    /**
  ...
  export interface EncryptionOptions {
    /**
     * The task master key (CMK) to use for the AWS Key Management Service (KMS). This key is used to encrypt your data at rest. If not provided, Amazon MQ will use a default CMK to encrypt your data.
     */
    KmsKeyId?: __string;
    /**
