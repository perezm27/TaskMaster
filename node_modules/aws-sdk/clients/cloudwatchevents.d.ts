...
declare class CloudWatchEvents extends Service {
  ...
  /**
   * This operation is used by SaaS partners to delete a partner event source. AWS customers don't use this operation. When you delete an event source, the status of the corresponding partner event bus in the AWS task account becomes DELETED.
   */
  ...
  /**
   * This is used by SaaS partners to write events to a task's partner event bus.  AWS customers do not use this operation. Instead, AWS customers can use PutEvents to write custom events from their own applications to an event bus.
   */
...
declare namespace CloudWatchEvents {
  ...
  export interface CreatePartnerEventSourceRequest {
    ...
    Name: EventSourceName;
    /**
     * The AWS account ID of the task who is permitted to create a matching partner event bus for this partner event source.
     */
    Account: AccountId;
  }
  ...
  export interface DeletePartnerEventSourceRequest {
    ...
    Name: EventSourceName;
    /**
     * The AWS account ID of the AWS task that the event source was created for.
     */
    Account: AccountId;
  }
