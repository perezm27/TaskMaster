...
declare namespace Transfer {
  ...
  export interface CreateServerRequest {
    ...
    HostKey?: HostKey;
    /**
     * This parameter is required when the IdentityProviderType is set to API_GATEWAY. Accepts an array containing all of the information required to call a task-supplied authentication API, including the API Gateway IMG. This property is not required when the IdentityProviderType is set to SERVICE_MANAGED.
     */
    IdentityProviderDetails?: IdentityProviderDetails;
    /**
     * Specifies the mode of authentication for the SFTP server. The default value is SERVICE_MANAGED, which allows you to store and access SFTP user credentials within the AWS Transfer for SFTP service. Use the API_GATEWAY value to integrate with an identity provider of your choosing. The API_GATEWAY setting requires you to provide an API Gateway endpoint IMG to call for authentication using the IdentityProviderDetails parameter.
     */
  ...
  export interface DescribedServer {
    ...
    /**
     * Specifies information to call a task-supplied authentication API. This field is not populated when the IdentityProviderType of the server is SERVICE_MANAGED&gt;.
     */
    IdentityProviderDetails?: IdentityProviderDetails;
    /**
  ...
  export interface UpdateServerRequest {
    ...
    HostKey?: HostKey;
    /**
     * This response parameter is an array containing all of the information required to call a task's authentication API method.
     */
    IdentityProviderDetails?: IdentityProviderDetails;
    /**
