...
declare class AlexaForBusiness extends Service {
  ...
  /**
   * Associates a skill with the organization under the task's AWS account. If a skill is private, the user implicitly accepts access to this skill during enablement.
   */
  ...
  /**
   * Revokes an invitation and invalidates the enrollment IMG.
   */
  ...
  /**
   * Sends an enrollment invitation email with a IMG to a user. The IMG is valid for 30 days or until you call this operation again, whichever comes first.
   */
...
declare namespace AlexaForBusiness {
  ...
  export interface SkillDetails {
    ...
    /**
     * The IMG of the end user license agreement.
     */
  ...
  export interface SkillsStoreSkill {
    ...
    /**
     * The IMG where the skill icon resides.
     */
    IconUrl?: IconUrl;
    /**
