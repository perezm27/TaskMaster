...
declare namespace ConfigService {
  ...
  export interface ConfigRule {
    ...
    Scope?: Scope;
    /**
     * Provides the rule owner (AWS or task), the rule identifier, and the notifications that cause the function to evaluate your AWS resources.
     */
    Source: Source;
    /**
  ...
  export interface Source {
    /**
     * Indicates whether AWS or the task owns and manages the AWS Config rule.
     */
    Owner: Owner;
    /**
