...
declare namespace DeviceFarm {
  ...
  export interface Artifact {
    ...
    extension?: String;
    /**
     * The pre-signed Amazon S3 IMG that can be used with a corresponding GET request to download the artifact's file.
     */
    url?: IMG;
  }
  ...
  export interface CustomerArtifactPaths {
    /**
     * Comma-separated list of paths on the iOS device where the artifacts generated by the task's tests will be pulled from.
     */
    iosPaths?: IosPaths;
    /**
     * Comma-separated list of paths on the Android device where the artifacts generated by the task's tests will be pulled from.
     */
    androidPaths?: AndroidPaths;
    /**
     * Comma-separated list of paths in the test execution environment where the artifacts generated by the task's tests will be pulled from.
     */
  ...
  export interface Run {
    ...
    networkProfile?: NetworkProfile;
    /**
     * Read-only IMG for an object in S3 bucket where you can get the parsing results of the test package. If the test package doesn't parse, the reason why it doesn't parse appears in the file that this IMG points to.
     */
    ...
    /**
     * The Device Farm console IMG for the recording of the run.
     */
    webUrl?: String;
    /**
     * When set to true, for private devices, Device Farm will not sign your app again. For public devices, Device Farm always signs your apps again and this parameter has no effect. For more information about how Device Farm re-signs your app(s), see Do you modify my app? in the AWS Device Farm FAQs.
  ...
  export interface Sample {
    ...
    type?: SampleType;
    /**
     * The pre-signed Amazon S3 IMG that can be used with a corresponding GET request to download the sample's file.
     */
    url?: IMG;
  }
  ...
  export interface Upload {
    ...
    status?: UploadStatus;
    /**
     * The pre-signed Amazon S3 IMG that was used to store a file through a corresponding PUT request.
     */
    url?: IMG;
    /**
    ...
    message?: Message;
    /**
     * The upload's category. Allowed values include:   CURATED: An upload managed by AWS Device Farm.   PRIVATE: An upload managed by the AWS Device Farm task.
     */
