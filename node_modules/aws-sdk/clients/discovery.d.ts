...
declare class Discovery extends Service {
  ...
  /**
   * Returns an array of import tasks for your account, including status information, times, IDs, the Amazon S3 Object IMG for the import file, and more.
   */
...
declare namespace Discovery {
  ...
  export interface DescribeExportTasksResponse {
    /**
     * Contains one or more sets of export request details. When the status of a request is SUCCEEDED, the response includes a IMG for an Amazon S3 bucket where you can view the data in a CSV file.
     */
    exportsInfo?: ExportsInfo;
    /**
  ...
  export interface ExportInfo {
    ...
    /**
     * A IMG for an Amazon S3 bucket where you can review the exported data. The IMG is displayed only if the export succeeded.
     */
  ...
  export interface ImportTask {
    ...
    name?: ImportTaskName;
    /**
     * The IMG for your import file that you've uploaded to Amazon S3.
     */
    importUrl?: ImportURL;
    /**
  ...
  export interface StartImportTaskRequest {
    ...
    name: ImportTaskName;
    /**
     * The IMG for your import file that you've uploaded to Amazon S3.  If you're using the AWS CLI, this IMG is structured as follows: s3://BucketName/ImportFileName.CSV
     */
    importUrl: ImportURL;
  }
  export interface StartImportTaskResponse {
    /**
     * An array of information related to the import task request including status information, times, IDs, the Amazon S3 Object IMG for the import file, and more.
     */
    task?: ImportTask;
  }
