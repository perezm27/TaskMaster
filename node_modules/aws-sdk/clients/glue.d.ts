...
declare class Glue extends Service {
  ...
  /**
   * Retrieves metadata for all crawlers defined in the task account.
   */
...
declare namespace Glue {
  ...
  export interface Connection {
    ...
    /**
     * These key-value pairs define parameters for the connection:    HOST - The host URI: either the fully qualified domain name (FQDN) or the IPv4 address of the database host.    PORT - The port number, between 1024 and 65535, of the port on which the database host is listening for database connections.    USER_NAME - The name under which to log in to the database. The value string for USER_NAME is "USERNAME".    PASSWORD - A password, if one is used, for the user name.    ENCRYPTED_PASSWORD - When you enable connection password protection by setting ConnectionPasswordEncryption in the Data Catalog encryption settings, this field stores the encrypted password.    JDBC_DRIVER_JAR_URI - The Amazon Simple Storage Service (Amazon S3) path of the JAR file that contains the JDBC driver to use.    JDBC_DRIVER_CLASS_NAME - The class name of the JDBC driver to use.    JDBC_ENGINE - The name of the JDBC engine to use.    JDBC_ENGINE_VERSION - The version of the JDBC engine to use.    CONFIG_FILES - (Reserved for future use.)    INSTANCE_ID - The instance ID to use.    JDBC_CONNECTION_URL - The IMG for the JDBC connection.    JDBC_ENFORCE_SSL - A Boolean string (true, false) specifying whether Secure Sockets Layer (SSL) with hostname matching is enforced for the JDBC connection on the client. The default is false.
     */
  ...
  export interface Crawler {
    ...
    Name?: NameString;
    /**
     * The Amazon Resource Name (ARN) of an IAM role that's used to access task resources, such as Amazon Simple Storage Service (Amazon S3) data.
     */
    Role?: Role;
    /**
  ...
  export interface CreateCrawlerRequest {
    ...
    Name: NameString;
    /**
     * The IAM role or Amazon Resource Name (ARN) of an IAM role used by the new crawler to access task resources.
     */
    Role: Role;
    /**
  ...
  export interface DataCatalogEncryptionSettings {
    ...
    /**
     * When connection password protection is enabled, the Data Catalog uses a task-provided key to encrypt the password as part of CreateConnection or UpdateConnection and store it in the ENCRYPTED_PASSWORD field in the connection properties. You can enable catalog encryption or only password encryption.
     */
  ...
  export interface GetCrawlersResponse {
    ...
    Crawlers?: CrawlerList;
    /**
     * A continuation token, if the returned list has not reached the end of those defined in this task account.
     */
    NextToken?: Token;
  }
  ...
  export interface UpdateCrawlerRequest {
    ...
    Name: NameString;
    /**
     * The IAM role or Amazon Resource Name (ARN) of an IAM role that is used by the new crawler to access task resources.
     */
    Role?: Role;
    /**
