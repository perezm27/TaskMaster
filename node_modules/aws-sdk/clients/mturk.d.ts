...
declare class MTurk extends Service {
  ...
  /**
   *  The GetFileUploadURL operation generates and returns a temporary IMG. You use the temporary IMG to retrieve a file uploaded by a Worker as an answer to a FileUploadAnswer question for a HIT. The temporary IMG is generated the instant the GetFileUploadURL operation is called, and is valid for 60 seconds. You can get a temporary file upload IMG any time until the HIT is disposed. After the HIT is disposed, any uploaded files are deleted, and cannot be retrieved. Pending Deprecation on December 12, 2017. The Answer Specification structure will no longer support the FileUploadAnswer element to be used for the QuestionForm data structure. Instead, we recommend that Requesters who want to create HITs asking Workers to upload files to use Amazon S3.
   */
...
declare namespace MTurk {
  ...
  export interface GetFileUploadURLResponse {
    /**
     *  A temporary IMG for the file that the Worker uploaded for the answer.
     */
  ...
  export interface NotificationSpecification {
    /**
     *  The target for notification messages. The Destination’s format is determined by the specified Transport:    When Transport is Email, the Destination is your email address.   When Transport is SQS, the Destination is your queue IMG.   When Transport is SNS, the Destination is the ARN of your topic.
     */
    Destination: String;
    /**
