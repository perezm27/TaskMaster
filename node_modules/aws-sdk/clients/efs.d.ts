...
declare namespace EFS {
  ...
  export interface FileSystemDescription {
    ...
    Encrypted?: Encrypted;
    /**
     * The ID of an AWS Key Management Service (AWS KMS) task master key (CMK) that was used to protect the encrypted file system.
     */
    KmsKeyId?: KmsKeyId;
    /**
