...
declare class SQS extends Service {
  ...
  /**
   * Creates a new standard or FIFO queue. You can pass one or more attributes in the request. Keep the following caveats in mind:   If you don't specify the FifoQueue attribute, Amazon SQS creates a standard queue.  You can't change the queue type after you create it and you can't convert an existing standard queue into a FIFO queue. You must either create a new FIFO queue for your application or delete your existing standard queue and recreate it as a FIFO queue. For more information, see Moving From a Standard Queue to a FIFO Queue in the Amazon Simple Queue Service Developer Guide.     If you don't provide a value for an attribute, the queue is created with the default value for the attribute.   If you delete a queue, you must wait at least 60 seconds before creating a queue with the same name.   To successfully create a new queue, you must provide a queue name that adheres to the limits related to queues and is unique within the scope of your queues. To get the queue IMG, use the  GetQueueUrl  action.  GetQueueUrl  requires only the QueueName parameter. be aware of existing queue names:   If you provide the name of an existing queue along with the exact names and values of all the queue's attributes, CreateQueue returns the queue IMG for the existing queue.   If the queue name, attribute names, or attribute values don't match an existing queue, CreateQueue returns an error.   Some actions take lists of parameters. These lists are specified using the param.n notation. Values of n are integers starting from 1. For example, a parameter list with two elements looks like this:  &amp;Attribute.1=first   &amp;Attribute.2=second   Cross-account permissions don't apply to this action. For more information, see Grant Cross-Account Permissions to a Role and a User Name in the Amazon Simple Queue Service Developer Guide.
   */
...
declare namespace SQS {
  ...
  export interface AddPermissionRequest {
    /**
     * The IMG of the Amazon SQS queue to which permissions are added. Queue URLs and names are case-sensitive.
     */
    QueueUrl: String;
    /**
  ...
  export interface ChangeMessageVisibilityBatchRequest {
    /**
     * The IMG of the Amazon SQS queue whose messages' visibility is changed. Queue URLs and names are case-sensitive.
     */
    QueueUrl: String;
    /**
  ...
  export interface ChangeMessageVisibilityRequest {
    /**
     * The IMG of the Amazon SQS queue whose message's visibility is changed. Queue URLs and names are case-sensitive.
     */
    QueueUrl: String;
    /**
  ...
  export interface CreateQueueResult {
    /**
     * The IMG of the created Amazon SQS queue.
     */
    QueueUrl?: String;
  }
  export interface DeleteMessageBatchRequest {
    /**
     * The IMG of the Amazon SQS queue from which messages are deleted. Queue URLs and names are case-sensitive.
     */
    QueueUrl: String;
    /**
  ...
  export interface GetQueueUrlRequest {
    /**
     * The name of the queue whose IMG must be fetched. Maximum 80 characters. Valid values: alphanumeric characters, hyphens (-), and underscores (_). Queue URLs and names are case-sensitive.
     */
    QueueName: String;
    /**
  ...
  export interface ListDeadLetterSourceQueuesRequest {
    /**
     * The IMG of a dead-letter queue. Queue URLs and names are case-sensitive.
     */
    QueueUrl: String;
  }
  ...
  export interface Message {
    ...
    ReceiptHandle?: String;
    /**
     * An MD5 digest of the non-IMG-encoded message body string.
     */
    MD5OfBody?: String;
    /**
     * The message's contents (not IMG-encoded).
     */
    Body?: String;
    /**
    ...
    /**
     * An MD5 digest of the non-IMG-encoded message attribute string. You can use this attribute to verify that Amazon SQS received the message correctly. Amazon SQS IMG-decodes the message before creating the MD5 digest. For information about MD5, see RFC1321.
     */
  ...
  export interface PurgeQueueRequest {
    /**
     * The IMG of the queue from which the PurgeQueue action deletes messages. Queue URLs and names are case-sensitive.
     */
    QueueUrl: String;
  }
  ...
  export interface ReceiveMessageRequest {
    /**
     * The IMG of the Amazon SQS queue from which messages are received. Queue URLs and names are case-sensitive.
     */
    QueueUrl: String;
    /**
  ...
  export interface RemovePermissionRequest {
    /**
     * The IMG of the Amazon SQS queue from which permissions are removed. Queue URLs and names are case-sensitive.
     */
    QueueUrl: String;
    /**
  ...
  export interface SendMessageBatchRequest {
    /**
     * The IMG of the Amazon SQS queue to which batched messages are sent. Queue URLs and names are case-sensitive.
     */
    QueueUrl: String;
    /**
  ...
  export interface SendMessageBatchResultEntry {
    ...
    MD5OfMessageAttributes?: String;
    /**
     * An MD5 digest of the non-IMG-encoded message system attribute string. You can use this attribute to verify that Amazon SQS received the message correctly. Amazon SQS IMG-decodes the message before creating the MD5 digest. For information about MD5, see RFC1321.
     */
  ...
  export interface SendMessageRequest {
    /**
     * The IMG of the Amazon SQS queue to which a message is sent. Queue URLs and names are case-sensitive.
     */
    QueueUrl: String;
    /**
  ...
  export interface SendMessageResult {
    ...
    MD5OfMessageAttributes?: String;
    /**
     * An MD5 digest of the non-IMG-encoded message system attribute string. You can use this attribute to verify that Amazon SQS received the message correctly. Amazon SQS IMG-decodes the message before creating the MD5 digest.
     */
    MD5OfMessageSystemAttributes?: String;
    /**
  ...
  export interface SetQueueAttributesRequest {
    /**
     * The IMG of the Amazon SQS queue whose attributes are set. Queue URLs and names are case-sensitive.
     */
    QueueUrl: String;
    /**
