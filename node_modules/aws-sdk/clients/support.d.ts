...
declare class Support extends Service {
  ...
  /**
   * Adds additional task communication to an AWS Support case. You use the caseId value to identify the case to add communication to. You can list a set of email addresses to copy on the communication using the ccEmailAddresses value. The communicationBody value contains the text of the communication. The response indicates the success or failure of the request. This operation implements a subset of the features of the AWS Support Center.
   */
...
declare namespace Support {
  ...
  export interface Communication {
    ...
    caseId?: CaseId;
    /**
     * The text of the communication between the task and AWS Support.
     */
  ...
  export interface CreateCaseRequest {
    ...
    serviceCode?: ServiceCode;
    /**
     * The code for the severity level returned by the call to DescribeSeverityLevels.  The availability of severity levels depends on each task's support subscription. In other words, your subscription may not necessarily require the urgent level of response time.
     */
    severityCode?: SeverityCode;
    /**
     * The category of problem for the AWS Support case.
    ...
    language?: Language;
    /**
     * The type of issue for the case. You can specify either "task-service" or "technical." If you do not indicate a value, the default is "technical."
     */
    issueType?: IssueType;
    /**
