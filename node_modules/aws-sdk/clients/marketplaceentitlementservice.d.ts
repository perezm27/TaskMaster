...
declare class MarketplaceEntitlementService extends Service {
  ...
  /**
   * GetEntitlements retrieves entitlement values for a given product. The results can be filtered based on task identifier or product dimensions.
   */
...
declare namespace MarketplaceEntitlementService {
  ...
  export interface Entitlement {
    ...
    /**
     * The task identifier is a handle to each unique task in an application. Customer identifiers are obtained through the ResolveCustomer operation in AWS Marketplace Metering Service.
     */
    CustomerIdentifier?: NonEmptyString;
    /**
     * The EntitlementValue represents the amount of capacity that the task is entitled to for the product.
     */
    Value?: EntitlementValue;
    /**
     * The expiration date represents the minimum date through which this entitlement is expected to remain valid. For contractual products listed on AWS Marketplace, the expiration date is the date at which the task will renew or cancel their contract. Customers who are opting to renew their contract will still have entitlements with an expiration date.
     */
  ...
  export interface GetEntitlementsRequest {
    ...
    ProductCode: ProductCode;
    /**
     * Filter is used to return entitlements for a specific task or for a specific dimension. Filters are described as keys mapped to a lists of values. Filtered requests are unioned for each value in the value list, and then intersected for each filter key.
     */
