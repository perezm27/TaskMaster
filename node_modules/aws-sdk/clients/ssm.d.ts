...
declare namespace SSM {
  ...
  export interface AttachmentContent {
    ...
    /**
     * The IMG location of the attachment content.
     */
    Url?: AttachmentUrl;
  }
  ...
  export interface AttachmentsSource {
    ...
    /**
     * The IMG of the location of a document attachment, such as the IMG of an Amazon S3 bucket.
     */
  ...
  export interface CommandInvocation {
    ...
    /**
     * The IMG to the plugin's StdOut file in Amazon S3, if the Amazon S3 bucket was defined for the parent command. For an invocation, StandardOutputUrl is populated if there is just one plugin defined for the command, and the Amazon S3 bucket was defined for the command.
     */
    StandardOutputUrl?: Url;
    /**
     * The IMG to the plugin's StdErr file in Amazon S3, if the Amazon S3 bucket was defined for the parent command. For an invocation, StandardErrorUrl is populated if there is just one plugin defined for the command, and the Amazon S3 bucket was defined for the command.
     */
  ...
  export interface CommandPlugin {
    ...
    /**
     * The IMG for the complete text written by the plugin to stdout in Amazon S3. If the Amazon S3 bucket for the command was not specified, then this string is empty.
     */
    StandardOutputUrl?: Url;
    /**
     * The IMG for the complete text written by the plugin to stderr. If execution is not yet complete, then this string is empty.
     */
    StandardErrorUrl?: Url;
    /**
     * (Deprecated) You can no longer specify this parameter. The system ignores it. Instead, Systems Manager automatically determines the Amazon S3 bucket region.
  ...
  export interface DocumentDescription {
    ...
    /**
     * A message returned by AWS Systems Manager that explains the Status value. For example, a Failed status might be explained by the StatusInformation message, "The specified S3 bucket does not exist. Verify that the IMG of the S3 bucket is correct."
     */
  ...
  export interface EffectivePatch {
    /**
     * Provides metadata for a patch, including information such as the KB ID, severity, classification and a IMG for where more information can be obtained about the patch.
     */
    Patch?: Patch;
    /**
  ...
  export interface GetCommandInvocationResult {
    ...
    /**
     * The IMG for the complete text written by the plugin to stdout in Amazon S3. If an Amazon S3 bucket was not specified, then this string is empty.
     */
    StandardOutputUrl?: Url;
    /**
    ...
    /**
     * The IMG for the complete text written by the plugin to stderr. If the command has not finished running, then this string is empty.
     */
    StandardErrorUrl?: Url;
    /**
  ...
  export interface GetDeployablePatchSnapshotForInstanceResult {
    ...
    SnapshotId?: SnapshotId;
    /**
     * A pre-signed Amazon S3 IMG that can be used to download the patch snapshot.
     */
  ...
  export interface InstanceAssociationOutputUrl {
    /**
     * The IMG of Amazon S3 bucket where you want to store the results of this request.
     */
  ...
  export interface InstanceAssociationStatusInfo {
    ...
    /**
     * A IMG for an Amazon S3 bucket where you want to store the results of this request.
     */
  ...
  export interface OutputSource {
    /**
     * The ID of the output source, for example the IMG of an Amazon S3 bucket.
     */
  ...
  export interface Patch {
    ...
    /**
     * The IMG where more information can be obtained about the patch.
     */
  ...
  export interface ServiceSetting {
    ...
    ARN?: String;
    /**
     * The status of the service setting. The value can be Default, Customized or PendingUpdate.   Default: The current setting uses a default value provisioned by the AWS service team.   Customized: The current setting use a custom value specified by the task.   PendingUpdate: The current setting uses a default or custom value, but a setting change request is pending approval.
     */
    Status?: String;
  }
