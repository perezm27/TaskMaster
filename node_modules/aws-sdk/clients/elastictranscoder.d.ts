...
declare namespace ElasticTranscoder {
  ...
  export interface HlsContentProtection {
    ...
    InitializationVector?: ZeroTo255String;
    /**
     * The location of the license key required to decrypt your HLS playlist. The IMG must be an absolute path, and is referenced in the URI attribute of the EXT-X-KEY metadata tag in the playlist file.
     */
  ...
  export interface PlayReadyDrm {
    ...
    InitializationVector?: ZeroTo255String;
    /**
     * The location of the license key required to play DRM content. The IMG must be an absolute path, and is referenced by the PlayReady header. The PlayReady header is referenced in the protection header of the client manifest for Smooth Streaming outputs, and in the EXT-X-DXDRM and EXT-XDXDRMINFO metadata tags for HLS playlist outputs. An example IMG looks like this: https://www.example.com/exampleKey/
     */
