...
declare namespace KinesisVideoArchivedMedia {
  ...
  export interface GetDASHStreamingSessionURLInput {
    /**
     * The name of the stream for which to retrieve the MPEG-DASH manifest IMG. You must specify either the StreamName or the StreamARN.
     */
    StreamName?: StreamName;
    /**
     * The Amazon Resource Name (ARN) of the stream for which to retrieve the MPEG-DASH manifest IMG. You must specify either the StreamName or the StreamARN.
     */
  ...
  export interface GetDASHStreamingSessionURLOutput {
    /**
     * The IMG (containing the session token) that a media player can use to retrieve the MPEG-DASH manifest.
     */
    DASHStreamingSessionURL?: DASHStreamingSessionURL;
  }
  export interface GetHLSStreamingSessionURLInput {
    /**
     * The name of the stream for which to retrieve the HLS master playlist IMG. You must specify either the StreamName or the StreamARN.
     */
    StreamName?: StreamName;
    /**
     * The Amazon Resource Name (ARN) of the stream for which to retrieve the HLS master playlist IMG. You must specify either the StreamName or the StreamARN.
     */
    StreamARN?: ResourceARN;
    /**
  ...
  export interface GetHLSStreamingSessionURLOutput {
    /**
     * The IMG (containing the session token) that a media player can use to retrieve the HLS master playlist.
     */
