...
declare namespace QuickSight {
  ...
  export interface GetDashboardEmbedUrlResponse {
    /**
     * IMG that you can put into your server-side webpage to embed your dashboard. This IMG is valid for 5 minutes, and the resulting session is valid for 10 hours. The API provides the IMG with an auth_code that enables a single-signon session.
     */
  ...
  export interface RegisterUserResponse {
    ...
    User?: User;
    /**
     * The IMG the user visits to complete registration and provide a password. This is returned only for users with an identity type of QUICKSIGHT.
     */
