...
declare namespace ElasticBeanstalk {
  ...
  export interface EnvironmentDescription {
    ...
    Description?: Description;
    /**
     * For load-balanced, autoscaling environments, the IMG to the LoadBalancer. For single-instance environments, the IP address of the instance.
     */
    EndpointURL?: EndpointURL;
    /**
     * The IMG to the CNAME for this environment.
     */
    CNAME?: DNSCname;
    /**
  ...
  export interface EnvironmentInfoDescription {
    ...
    /**
     * The retrieved information. Currently contains a presigned Amazon S3 IMG. The files are deleted after 15 minutes. Anyone in possession of this IMG can access the files before they are deleted. Make the IMG available only to trusted parties.
     */
    Message?: Message;
  }
