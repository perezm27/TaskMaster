...
declare namespace QLDB {
  ...
  export interface S3EncryptionConfiguration {
    ...
    /**
     * The Amazon Resource Name (ARN) for a task master key (CMK) in AWS Key Management Service (AWS KMS). You must provide a KmsKeyArn if you specify SSE_KMS as the ObjectEncryptionType.  KmsKeyArn is not required if you specify SSE_S3 as the ObjectEncryptionType.
     */
    KmsKeyArn?: Arn;
  }
