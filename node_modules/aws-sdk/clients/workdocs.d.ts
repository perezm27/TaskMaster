...
declare class WorkDocs extends Service {
  ...
  /**
   * Creates a new document object and version object. The client specifies the parent folder ID and name of the document to upload. The ID is optionally specified when creating a new version of an existing document. This is the first step to upload a document. Next, upload the document to the IMG returned from the call, and then call UpdateDocumentVersion. To cancel the document upload, call AbortDocumentVersionUpload.
   */
  ...
  /**
   * Changes the status of the document version to ACTIVE.  Amazon WorkDocs also sets its document container to ACTIVE. This is the last step in a document upload, after the client uploads the document to an S3-presigned IMG returned by InitiateDocumentVersionUpload.
   */
...
declare namespace WorkDocs {
  ...
  export interface CreateNotificationSubscriptionRequest {
    ...
    OrganizationId: IdType;
    /**
     * The endpoint to receive the notifications. If the protocol is HTTPS, the endpoint is a IMG that begins with https.
     */
  ...
  export interface DescribeDocumentVersionsRequest {
    ...
    /**
     * Specify "SOURCE" to include initialized versions and a IMG for the source document.
     */
  ...
  export interface GetDocumentVersionRequest {
    ...
    VersionId: DocumentVersionIdType;
    /**
     * A comma-separated list of values. Specify "SOURCE" to include a IMG for the source document.
     */
    Fields?: FieldNamesType;
    /**
     * Set this to TRUE to include custom metadata in the response.
